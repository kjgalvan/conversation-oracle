...
export function getGroceryScenario(name) {
  var scenario = [
    ...
    {
      dialog:
        "Oh nice. I've been busy with work and trying to move out of my parents' house.",
      emote: Emotes.happy,
      buttons: [
        {
          onClick: () => {
        ...
        },
        {
          ...
          text:
            "You’re moving out? That’s so cool! Oh, but are ready to live on your own? "
        }
      ]
    },
    {
      ...
      buttons: [
        {
          ...
          text: "Dude, you like pineapples? Those taste like garbage!"
        },
        {
          onClick: () => {
            console.log("Pressed");
      ...
      buttons: [
        {
          ...
          text: "I'm doing pretty good. What's your name?"
        },
        {
          onClick: () => {
            console.log("Pressed");
          },
          text: "I hate life right now. Who even are you?"
        },
        {
          onClick: () => {
            console.log("Pressed");
          },
          text: "Pretty good. Hey, what's your name, by the way?"
        },
        {
          onClick: () => {
            console.log("Pressed");
